...
QUEUE_NAME = 'nimbus.l2rabbit.test.queue'
...
EM.schedule do
  ...
  AMQP.connect(Nimbus::Config.l2rabbit) do |connection|
...
module Nimbus
  ...
  class ServicesApp < Sinatra::Base
    ...
    get '/l2rabbit/publish' do
      ...
      puts 'message published to l2rabbitmq'
      'message published to l2rabbitmq'
    end

    get '/l2rabbit/check/:instance_count' do
